  ...
  return (
    <>
      <Layout>
        ...
        <Container>
          <Intro />
          {heroPost && <HeroPost title={heroPost[0].title} coverImage={heroPost[0].coverImage} date={heroPost[0].date} author={heroPost[0].author} slug={heroPost[0].slug} excerpt={heroPost[0].excerpt} />}
